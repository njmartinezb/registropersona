        ...
        <!-- used to have bg-white or dark:bg-gray-800 -->
            <div class="dark:text-white overflow-hidden shadow-sm sm:rounded-lg grid grid-cols-1 md:grid-cols-2 gap-4 px-6">
                ...
                @foreach ($cities as $index => $city)
                        ...
                        >
                            ...
                            <!--
                                <a href="{{ route('cities.edit', $city) }}"
                                   class="border p-2 rounded-md border-white hover:bg-white hover:text-black transition">
                                   Edit
                                </a>
                                -->
                                <button
                    ...
                    <form action="{{ route('cities.update', ['city' => $city->id]) }}" method="POST" class="space-y-6"> @csrf
                    @method("PUT")
                    <div>
